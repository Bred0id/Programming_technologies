...
4. Создайте виртуальное окружение и добавьте его в .gitignore (если вы создаете окружение внутри проекта)
...
6. Чтобы запустить файл main, необходимо выполнить команду:

`PYTHONPATH=src python main.py`

7. Чтобы выполнить запуск тестов, необходимо выполнить команду:
...
В третьем примере тестируется адаптер для сервисов погоды, который умеет возвращать текущее значение температуры и текстовое сообщение о разнице температур
